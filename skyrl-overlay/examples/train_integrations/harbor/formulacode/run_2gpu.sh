...
#   CUDA_VISIBLE_DEVICES=5,7 bash examples/train_integrations/harbor/formulacode/run_2gpu.sh
set -euo pipefail
...
# Directories
#-----------------------
RUN_NAME="formulacode-grpo-g8-2gpu"
...
#-----------------------
NUM_POLICY_GPUS=2
NUM_INFERENCE_ENGINES=2      # dp_size=2: 5*8/2=20 seqs per GPU per step
TP_SIZE=1
HTTP_PORT=8123
...
echo "=== FormulaCode RLVR 2-gpu run starting at $(date) ===" | tee -a "$LOGFILE"
